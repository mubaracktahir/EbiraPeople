...
class PeopleListFragment : BaseListFragment<FragmentListBinding>(R.layout.fragment_list ) {
    ...
    override fun addList() {
        mList.add(People(resources.getString(R.string.p2), resources.getString(R.string.p2_d),R.drawable.p2))
        mList.add(People(resources.getString(R.string.p3), resources.getString(R.string.p3_d),R.drawable.p3))
        mList.add(People(resources.getString(R.string.p4), resources.getString(R.string.p4_d),R.drawable.p4))
        mList.add(People(resources.getString(R.string.p5), resources.getString(R.string.p5_d),R.drawable.p5))
        mList.add(People(resources.getString(R.string.p6), resources.getString(R.string.p6_d),  R.drawable.demo))
        mList.add(People(resources.getString(R.string.p7), resources.getString(R.string.p7_d),R.drawable.p7))
        mList.add(People(resources.getString(R.string.p8), resources.getString(R.string.p8_d),R.drawable.p8))
        mList.add(People(resources.getString(R.string.p9), resources.getString(R.string.p9_d),R.drawable.p9))
        mList.add(People(resources.getString(R.string.p10), resources.getString(R.string.p10_d),R.drawable.p10))
        mList.add(People(resources.getString(R.string.p11), resources.getString(R.string.p11_d),R.drawable.p11))
        mList.add(People(resources.getString(R.string.p12), resources.getString(R.string.p12_d),R.drawable.p12))
        mList.add(People(resources.getString(R.string.p13), resources.getString(R.string.p13_d),R.drawable.p13))
        mList.add(People(resources.getString(R.string.p14), resources.getString(R.string.p14_d),R.drawable.p14))
